...
mondir = ['X:\Cortex Data\' monkey '\'];
%imgdir = 'X:\eblab\Cortex Programs\DMS PS Yassa\DMSPS Training\Training Image Sets\';
...
% ============= OVERRIDE FILE LIST HERE!!!!!!!! =============
 filelist=['BL170808.1'; 'BL170808.2'];% 'BL170425.3'; 'BL170426.3';'BL170427.3'];
% -----------------------------------------------------------
