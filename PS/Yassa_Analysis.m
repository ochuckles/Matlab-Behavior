...
%
%   All Monkeys
      fileslist=['TO160525.2';'TO160603.2';'TO160606.2';'TO160607.2';'TO160608.2';'TO160609.2';'TO160613.2';'TO160614.2';...
          'PW160614.2';'PW160525.3';'PW160608.2';'PW160609.2';'PW160613.2';'PW160615.2';'PW160616.2';'PW160617.2';'PW160620.2';'PW160621.2';'PW160622.2';...
          'MF160525.2';'MF160607.2';'MF160610.2';'MF160613.2';'MF160615.2';...
          'WR160503.2';'WR160603.1';'WR160606.1';'WR160613.1';'WR160615.1';'WR160616.1';'WR160620.1';'WR160621.1';'WR160623.1';...
          'MP160608.2';'MP160610.2';'MP160615.2';'MP160616.2';'MP160622.2';'MP160623.2'];
...
%2: pre/post: 0/1
%3: monkey:
%1=Red; 2=Vivian; 3=Tobii; 4=Manfred; 5=Timmy
%4: Data collection day: 0/1
...
%column 1: monkey; 1=Red; 2=Vivian; 3=Tobii; 4=Manfred; 5=Timmy
%column 2: data collection No(0)/Yes(1)
%column 3: version
%column 4: pre(0)/post(1)
%column 5: trial
%column 6: block
%column 7: repeat or novel
%column 8: reaction time


% %put this in here to create repository of data files
% % go to database file and get it into matlab
% [~, ~, raw] = xlsread('X:\Ian\TL_Analysis\TL_analysis_clean.xlsx','A2:G162');
% %toy data set. comment out
% %[~, ~, raw] = xlsread('X:\Ian\TL_Analysis\TL_analysis_toy.xlsx','A2:G7');
...
%     monkeys  = {'Red', 'Vivian', 'Tobii', 'Manfred', 'Timmy'};
